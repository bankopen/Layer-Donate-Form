...
$comment="";
$remote_script="";
//orderid or transaction id is better to use for future tracking.
$orderid=date("ymd").'-'.rand(1,100);
...
if(empty($error) && isset($donate_btn)) {
	$remote_script = 'https://payments.open.money/layer'; //production		
	if( $sandbox == "yes")
    ...
    if(empty($error) && !empty($payment_token_data)){
        ...
        $html =  "<form action='".$redirect_page."' method='post' style='display: none' name='layer_payment_int_form'>
            ...
            <input type='hidden' name='woo_order_id' value='".$orderid."'>
...
<form id="donate" method="post">
	...
	<div><input id="donate_btn" name="donate_btn" type="submit"></div>
</form>
...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","licenseKey":"8ce0a4af47","applicationID":"252547701","transactionName":"Y1RTMhNTC0dRBRFaWloeZBQIHQxaVAMdHUVcQQ==","queueTime":0,"applicationTime":188,"atts":"TxNQRFtJGEk=","errorBeacon":"bam.nr-data.net","agent":""}</script>
</body>
</html>